...
This project accompanies my **Introduction to TensorFlow** live online trainings. It contains the exercises and their solutions, in the form of a [Jupyter](http://jupyter.org/) notebook.

During the course itself, a url will be provided for running the notebooks. You can participate in the course without installing anything local.
